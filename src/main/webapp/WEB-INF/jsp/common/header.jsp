...
<nav class="navbar nav-root" role="navigation" aria-label="main navigation">
	<div class="navbar-brand">
		...
		</a> <a role="button" class="navbar-burger" aria-label="menu" aria-expanded="false" data-target="navbarBasicExample">
	...
	<div id="navbarBasicExample" class="navbar-menu">
		...
		<div class="navbar-end">
			<div class="navbar-item">
				<div class="buttons">
					<a class="button is-primary" href="/register"> <strong>Sign up</strong>
					</a> <a class="button is-light" href="/login"> Log in </a>
				</div>
			</div>
		</div>
	</div>
